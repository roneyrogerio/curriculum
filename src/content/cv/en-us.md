...
seoTitle: "Roney de Oliveira | Software Engineer in Backend, Full Stack, and DevOps"
seoDescription: "Software Engineer resume focused on backend engineering, full stack delivery, and DevOps practices with microservices, AWS and GCP cloud, Kubernetes, Knative, and distributed systems reliability."
---
...
- Additional 42 Sao Paulo technical projects: `ft_services` (systems and network administration), `libasm` (Assembly), `ft_server` (Docker), `get_next_line`, `ft_printf`, and `libft`.
